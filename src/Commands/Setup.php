...
namespace Tualo\Office\Crontab\Commands;
...
class Setup extends BaseSetup implements ISetupCommandline
{
    ...
    {
        return 'perform a complete crontab setup';
    }
    ...
    public static function run(Args $args)
    {
        ...
        PostCheck::formatPrintLn(['blue'], "Installing all needed SQL procedures for crontab module");
